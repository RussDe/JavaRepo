 ...
 * that the comments direct you to complete. To restore the editor's original stub code, create a new buffer by clicking on the branch icon
 ...
 * Output Format
 * <p>
 * Stub code in the editor prints the sentence modified by the replaceAll line to stdout. The modified string must be a modified version
 * of the initial sentence where all repeat occurrences of each word are removed.
 * <p>
 * Sample Input
 * <p>
5
 ...
 * We remove the second occurrence of went and the second and third occurrences of to from Sam went went to to to his business to get Sam went
 * to his business.
 * We remove the second occurrence of is, the second occurrence of the, and the second occurrence of eye from Reya is is the the best player
...
class TextJavaRegex2DuplicateWords {
